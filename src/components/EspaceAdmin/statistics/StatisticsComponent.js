    ...
    <div style={{ padding: "20px", display: "flex", flexDirection: "column", height: "90vh" }}>
      ...
      >
        <Row gutter={[24, 24]}>
          ...
          <Col xs={24} sm={12} lg={8}>
            <Card
              title={<><IdcardOutlined style={{ marginRight: "10px" }} />Total freelancer</>}
              bordered={false}
              style={{
                textAlign: "center",
                backgroundColor: "#f7f7f7",
          ...
          <Col xs={24} lg={12}>
            <Card
              title={<><UnorderedListOutlined style={{ marginRight: "10px" }} />Nombre de Projets par Catégorie</>}
              bordered={false}
              style={{
                boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)",
                borderRadius: "10px"
      ...
      <Tooltip formatter={(value, name, props) => [`${value} formations`, props.payload.categorieName]} />
          ...
          <Col xs={24} lg={12}>
          <Card
  title={<><UnorderedListOutlined style={{ marginRight: "10px" }} />Nombre de freelancer par domaine</>}
  bordered={false}
  style={{
    boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)",
    borderRadius: "10px"
